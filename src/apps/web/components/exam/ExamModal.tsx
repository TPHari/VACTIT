...
//Chức năng: Đây là cái Popup (cửa sổ bật lên) khi bạn bấm vào nút "Chi tiết" hoặc bấm vào tên đề thi. Nó hiện ra thông tin đầy đủ, hướng dẫn làm bài và làm mờ nền phía sau.
      ...
      <div className="bg-white rounded-[2rem] w-full max-w-5xl relative z-10 overflow-hidden shadow-2xl animate-scale-up flex flex-col max-h-[90vh]">
        ...
        <div className="p-8 md:p-10 overflow-y-auto">
          ...
          <div className="space-y-3 mt-auto">
            <Link href={`/exam/${exam.id}`} className="block w-full">
