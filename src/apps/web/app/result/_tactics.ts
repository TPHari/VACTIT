  ...
  vie: [
    {
      ...
      max: 100,
      messages: [
        `Điểm thấp ở phần này thường không phải do bạn dở Tiếng Việt, mà do bạn chủ quan đấy. Tiếng Việt là tiếng mẹ đẻ, nhưng đề thi rất hay bẫy lỗi chính tả, lỗi dùng từ và yêu cầu một khả năng đọc hiểu cao. BaiLearn khuyên bạn đừng đọc lướt nha, mà hãy rèn thói quen đọc chậm, đọc kỹ từng từ trong câu hỏi để tránh mất điểm oan uổng. Bạn hãy dành 3 ngày chỉ để ôn lại quy tắc chính tả và các cặp từ hay nhầm (như 'bàng quan' hay 'bàng quang'). Bên cạnh đó, hãy mở lại sách giáo khoa Ngữ văn lớp 10, 11, 12 và ôn thật kỹ các biện pháp tu từ (ẩn dụ, hoán dụ, nhân hóa...) cùng ngữ pháp câu tiếng Việt nhé!`,
        `Điểm số hiện tại  không phải cho thấy bạn kém Tiếng Việt, mà nguyên nhân chính là sự chủ quan. Đề thi thường giăng bẫy ở lỗi chính tả và dùng từ, đòi hỏi sự tỉ mỉ cao. Chiến lược khắc phục: Bạn cần thay đổi ngay thói quen đọc lướt sang đọc chậm, soi kỹ từng từ trong câu hỏi. Hãy lên lịch dành hẳn 3 ngày chỉ để hệ thống hóa quy tắc chính tả và phân biệt các cặp từ dễ gây nhầm lẫn (ví dụ điển hình như 'bàng quan' và 'bàng quang'). Song song đó, hãy mở lại sách giáo khoa Ngữ văn lớp 10, 11, 12 để ôn tập thật sâu các biện pháp tu từ (ẩn dụ, hoán dụ, nhân hóa...) và nắm chắc ngữ pháp câu.`,
